...
layui.define(["table", "form"],
    function (e) {
        ...
        //滚动余额悬浮窗数据---码商后台
        i.render({
            elem: "#app-pay-code-balance-ms-list",
            url: "getBalanceList",
            //自定义响应字段
            response: {
                statusCode: 1 //数据状态一切正常的状态码
            ...
            cols: [
                [/*{
                ...
                },*/
                    {
                        ...
                        title: "账户信息",
                        templet: function (d) {
                            return d.account_name + '&nbsp&nbsp' + d.bank_name + '&nbsp&nbsp:' + d.format_acount_number
            ...
            //滚动余额悬浮窗数据
            i.render({
                elem: "#app-pay-code-balance-list",
                url: "getBalanceList",
                //自定义响应字段
                response: {
                    statusCode: 1 //数据状态一切正常的状态码
