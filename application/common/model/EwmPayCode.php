...
//var_dump($where);die();
     ...
     */
    public function getFormatAcountNumberAttr($value, $row)
    {
        $accountNumber = $row['account_number'];
        $accountNumber = substr_replace($row['account_number'], "****", 4, strlen($accountNumber) - 8);
        return $accountNumber;
    }


    public function getFormatAcountNumberForMsAttr($value, $row)
    {
        $accountNumber = $row['account_number'];
        $accountNumber = substr_replace($row['account_number'], "**", 2, strlen($accountNumber) - 6);
        return $accountNumber;
    }
